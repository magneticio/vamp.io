...
Error: File to import not found or unreadable: mod-one/assets.
        on line 1 of both_assets.scss

1: @import "mod-one/assets";
2: @import "assets";
3: 
4: .test {
5:   background: asset-url("images/foo.png");
6:   background: asset-url("fonts/foo.woff");
...
body:before {
  ...
  content: "Error: File to import not found or unreadable: mod-one/assets.\A         on line 1 of both_assets.scss\A \A 1: @import \"mod-one/assets\";\A 2: @import \"assets\";\A 3: \A 4: .test {\A 5:   background: asset-url(\"images/foo.png\");\A 6:   background: asset-url(\"fonts/foo.woff\");"; }
