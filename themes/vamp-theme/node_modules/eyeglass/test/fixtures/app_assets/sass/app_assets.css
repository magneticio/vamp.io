/*
Error: File to import not found or unreadable: assets.
        on line 1 of app_assets.scss

1: @import "assets";
2: 
3: .test {
4:   background: asset-url("images/foo.png");
5:   background: asset-url("fonts/foo.woff");
6: }
...
body:before {
  ...
  content: "Error: File to import not found or unreadable: assets.\A         on line 1 of app_assets.scss\A \A 1: @import \"assets\";\A 2: \A 3: .test {\A 4:   background: asset-url(\"images/foo.png\");\A 5:   background: asset-url(\"fonts/foo.woff\");\A 6: }"; }
