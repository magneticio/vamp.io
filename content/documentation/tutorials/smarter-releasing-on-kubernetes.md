...
![architecture](/images/diagram/v120/tut5/k8s-arch-mvp-product-crelease.png)
...
- If you have `kubectl proxy` running on port 8001 (the default port), you check the deployment by:
  ...
  - Open the link in your web browser and you should see the following output:
    ![sava-product/products/ie](/images/screens/v120/tut5/sava-product-products-ie-v1.png)
...
Vamp gateways provide [a super set of Kubernetes Service and Ingress controller features](/documentation/how-vamp-works/v1.2.0/vamp-and-kubernetes/#vamp-deployments) and allow you to do fine-grained, automated or manual blue/green or canary releases of your internal-facing and external-facing microservices.
...
1. In the Vamp UI, select the environment _environment_ and go to the **Gateways** page and click **Add** (top right)
...
- If you have `kubectl proxy` running on port 8001, you check the deployment by:
  ...
  - Open the link in your web browser and you should see the IE product page:
    ![sava-cart-ie-v1](/images/screens/v120/tut5/sava-cart-ie-v1.png)
...
1. In the Vamp UI, select the environment _environment_ and go to the **Gateways** page and open the **sava-product** gateway
2. Click the edit icon next to **WEIGHT**
3. Adjust the weight slider to distribute traffic 50% / 50% between the two versions
   ![](/images/screens/v120/tut5/vampee-environment-gateways-sava-product-editweights5050.png)
...
- Find out more about the synergy between [Vamp and Kubernetes](/documentation/how-vamp-works/v1.2.0/vamp-and-kubernetes/)
  {{< /note >}}
