...
For details on how to customise your Vamp configuration, see [how to configure Vamp](/documentation/configure/v1.0.0/configure-vamp/).

**Vamp:**

* [Vamp configuration](/documentation/configure/v1.0.0/configuration-reference/#vamp-configuration)
* [Vamp lifter](/documentation/configure/v1.0.0/configuration-reference/#vamp-lifter-configuration)

**By vendor:**

* [DC/OS (Mesos, Marathon & Chronos)](/documentation/configure/v1.0.0/configuration-reference/#dc-os-configuration)
* [Kubernetes](/documentation/configure/v1.0.0/configuration-reference/#kubernetes-configuration)
* [Rancher](/documentation/configure/v1.0.0/configuration-reference/#rancher-configuration)
* [Docker](/documentation/configure/v1.0.0/configuration-reference/#docker-configuration)
* [AWS](/documentation/configure/v1.0.0/configuration-reference/#aws-configuration)
* [Elasticsearch](/documentation/configure/v1.0.0/configuration-reference/#elasticsearch-configuration)
* [MySQL](/documentation/configure/v1.0.0/configuration-reference/#mysql-configuration)
* [PostgreSQL](/documentation/configure/v1.0.0/configuration-reference/#postgresql-configuration)
* [Microsoft SQL server](/documentation/configure/v1.0.0/configuration-reference/#microsoft-sql-server-configuration)
* [In-Memory only](/documentation/configure/v1.0.0/configuration-reference/#in-memory-only-persistence)
* [Zookeeper](/documentation/configure/v1.0.0/configuration-reference/#zookeeper-configuration)
* [Consul](/documentation/configure/v1.0.0/configuration-reference/#consul-configuration)
* [etcd](/documentation/configure/v1.0.0/configuration-reference/#etcd-configuration)
* [Redis](/documentation/configure/v1.0.0/configuration-reference/#redis-configuration)
* [HAProxy](/documentation/configure/v1.0.0/configuration-reference/#haproxy-configuration)
...
[bootstrap](/documentation/configure/v1.0.0/configuration-reference/#vamp-bootstrap), [common](/documentation/configure/v1.0.0/configuration-reference/#vamp-common), [container driver](/documentation/configure/v1.0.0/configuration-reference/#vamp-container-driver), [gateway driver](/documentation/configure/v1.0.0/configuration-reference/#vamp-gateway-driver), [http-api](/documentation/configure/v1.0.0/configuration-reference/#vamp-http-api), [model](/documentation/configure/v1.0.0/configuration-reference/#vamp-model), [operation](/documentation/configure/v1.0.0/configuration-reference/#vamp-operation), [persistence](/documentation/configure/v1.0.0/configuration-reference/#vamp-persistence), [pulse](/documentation/configure/v1.0.0/configuration-reference/#vamp-pulse), [workflow driver](/documentation/configure/v1.0.0/configuration-reference/#vamp-workflow-driver)
...
See the [example configurations](/documentation/configure/v1.0.0/example-configurations) and the associated reference.conf files:

* [DC/OS (Mesos, Marathon & Chronos)](/documentation/configure/v1.0.0/configuration-reference/#dc-os-configuration), [Kubernetes](/documentation/configure/v1.0.0/configuration-reference/#kubernetes-configuration), [Rancher](/documentation/configure/v1.0.0/configuration-reference/#rancher-configuration), [Docker](/documentation/configure/v1.0.0/configuration-reference/#docker-configuration), [AWS](/documentation/configure/v1.0.0/configuration-reference/#aws-configuration).
