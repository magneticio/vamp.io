...
menu:
  main:
    identifier: "ts-hello-world-quickstart-v093"
...
- Reinstall [Vamp hello world](/documentation/installation/v0.9.3/hello-world/).
- If everything is installed ok and you're running into problems using Vamp, check the [troubleshooting tips for using Vamp](/documentation/troubleshoot/v0.9.3/tips-for-using-vamp).
