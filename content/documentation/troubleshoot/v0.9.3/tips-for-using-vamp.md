...
menu:
  main:
    identifier: "ts-tips-for-using-vamp-v093"
...
1. Confirm that everything is installed ok:
  - Check the Vamp info (using `GET <vamp url>/api/v1/info` or in the info pane of the Vamp UI).
    If a component is not listed or reported as **not connected**, check the instructions to [troubleshoot a full Vamp installation](/documentation/troubleshoot/v0.9.3/full-vamp-installation) or [troubleshoot the Vamp Hello world quickstart](/documentation/troubleshoot/v0.9.3/hello-world-quickstart).
...
- Still not working? [Report an issue](/documentation/troubleshoot/v0.9.3/tips-for-using-vamp/#report-an-issue).
