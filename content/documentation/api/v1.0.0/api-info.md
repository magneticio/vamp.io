...
menu:
  main:
    parent: "API"
    identifier: "api-reference-info-v100"
    weight: 170
aliases:
 ...
 * [List](/documentation/api/v1.0.0/api-info/#list-info) - returns a full list of all info parameters.
 * [Get](/documentation/api/v1.0.0/api-info/#get-specific-info-section) - explicitly request a specific info section.
...
### Response
If successful, will return a list of [all info parameters](/documentation/api/v1.0.0/api-info/#info-parameters).
...
Return a specific info section, see [info parameters](/documentation/api/v1.0.0/api-info/#info-parameters).
...
### Response
If successful, will return a list with only the standard and specified [info parameters](/documentation/api/v1.0.0/api-info/#info-parameters).
