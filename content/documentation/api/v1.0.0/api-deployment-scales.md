...
menu:
  main:
    parent: "API"
    identifier: "api-reference-deployment-scales-v100"
    weight: 100
aliases:
 ...
 * [Get](/documentation/api/v1.0.0/api-deployment-scales/#get-single-deployment-scale) - return details of a specific deployment scale
 * [Update](/documentation/api/v1.0.0/api-deployment-scales/#update-deployment-scale) - update a deployment scale
...
### Response
If successful, will return the specified [scale resource](/documentation/api/v1.0.0/api-scales/#scale-resource) in the specified `accept` format (default JSON).
...
* `PUT`
* `/api/v1/deployments/{deployment_name}/clusters/{cluster_name}/services/{service_name}/scale`
* The request body should include at least the [minimum scale resource](/documentation/api/v1.0.0/api-scales/#scale-resource) in the specified `content-type` format (default JSON).
