...
menu:
  main:
    parent: "API"
    identifier: "api-reference-common-parameters-v100"
    weight: 20
aliases:
...
The headers described below can be added to all API requests to [specify JSON or YAML](/documentation/api/v1.0.0/using-the-api/#request-and-response-format) for requests and responses, and [manage pagination](/documentation/api/v1.0.0/using-the-api/#pagination) for responses.
