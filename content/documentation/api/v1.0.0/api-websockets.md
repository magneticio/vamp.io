...
menu:
  main:
    parent: "API"
    identifier: "api-reference-websockets-v100"
    weight: 30
aliases:
...
* [WebSocket API requests](/documentation/api/v1.0.0/api-websockets/#websocket-api-requests)
* [Websocket API responses](/documentation/api/v1.0.0/api-websockets/#websocket-api-responses)
