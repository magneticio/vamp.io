...
menu:
  main:
    parent: "API"
    identifier: "api-reference-config-v100"
    weight: 70
aliases:
 ...
 * [List](/documentation/api/v1.0.0/api-config/#list-config) - returns a full list of all config parameters.
 * [Get](/documentation/api/v1.0.0/api-config/#get-specific-config-parameter) - explicitly request a specific config parameter.
...
### Response
If successful, will return a list of [all config parameters](/documentation/api/v1.0.0/api-config/#config-parameters). Parameters are described in detail in the [configuration reference](/documentation/configure/configuration-reference).
...
### Response
If successful, will return the specified [config parameter](/documentation/api/v1.0.0/api-config/#config-parameters).
