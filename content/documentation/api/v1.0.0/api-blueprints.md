...
menu:
  main:
    parent: "API"
    identifier: "api-reference-blueprints-v100"
    weight: 40
aliases:
 ...
 * [List](/documentation/api/v1.0.0/api-blueprints/#list-blueprints) - return a list of all stored blueprints
 * [Get](/documentation/api/v1.0.0/api-blueprints/#get-blueprint) - get a single stored blueprint
 * [Create](/documentation/api/v1.0.0/api-blueprints/#create-blueprint) - create a new blueprint
 * [Update](/documentation/api/v1.0.0/api-blueprints/#update-blueprint) - update an existing blueprint
 * [Delete](/documentation/api/v1.0.0/api-blueprints/#delete-blueprint) - delete a stored blueprint
...
```
 ...
 gateways | optional |  Can be created separately and referenced from here or defined inline as part of the blueprint. See [gateway resource](/documentation/api/v1.0.0/api-gateways/#gateway-resource)
 clusters | required  |
 services | required |
 breed |  required |Can be created separately and referenced from here or defined inline as part of the blueprint. See [breed resource](/documentation/api/v1.0.0/api-breeds)
...
Return a list of all stored blueprint resources. For details on pagination see [common parameters](/documentation/api/v1.0.0/using-the-api)
...
### Response
If successful, will return a list of [blueprint resources](/documentation/api/v1.0.0/api-blueprints/#blueprint-resource) in the specified `accept` format (default JSON).
...
### Response
If successful, will return the named [blueprint resource](/documentation/api/v1.0.0/api-blueprints/#blueprint-resource) in the specified `accept` format (default JSON).
...
* `POST`
* `/api/v1/blueprints`
* The request body should contain at least a [minimum blueprint resource](/documentation/api/v1.0.0/api-blueprints/#blueprint-resource) in the specified `content-type` format (default JSON).
* Query string parameters:
...
### Response
A successful create operation has status code 201 `Created` and the response body will contain the created [blueprint resource](/documentation/api/v1.0.0/api-blueprints/#blueprint-resource) in the specified `accept` format (default JSON).
...
* `PUT`
* `/api/v1/blueprints/{blueprint_name}`
* The request body should contain at least a [minimum blueprint resource](/documentation/api/v1.0.0/api-blueprints/#blueprint-resource) in the specified `content-type` (default JSON). The name field must match the `blueprint_name` specified in the request path.
* Query string parameters:
...
### Response
A successful update operation has status code 200 `OK` or 202 `Accepted` and the response body will contain the updated [blueprint resource](/documentation/api/v1.0.0/api-blueprints/#blueprint-resource) in the specified `accept` format (default JSON).
