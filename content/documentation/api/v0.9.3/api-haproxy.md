...
menu:
  main:
    parent: "API"
    identifier: "api-reference-haproxy-093"
    weight: 150
---
 ...
 * [Get](/documentation/api/v0.9.3/api-haproxy/#get-haproxy-configuration) - get the HAProxy configuration for a version.
...
### Response
If successful, will return the [HA proxy configuration](/documentation/api/v0.9.3/api-haproxy/#haproxy-config-parameters) for the HAProxy `version_number` specified in the request path. 
