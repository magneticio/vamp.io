...
menu:
  main:
    parent: "API"
    identifier: "api-reference-info-092"
    weight: 170
---
 ...
 * [List](/documentation/api/v0.9.2/api-info/#list-info) - returns a full list of all info parameters.
 * [Get](/documentation/api/v0.9.2/api-info/#get-specific-info-section) - explicitly request a specific info section.
...
### Response
If successful, will return a list of [all info parameters](/documentation/api/v0.9.2/api-info/#info-parameters).
...
Return a specific info section, see [info parameters](/documentation/api/v0.9.2/api-info/#info-parameters). 
...
### Response
If successful, will return a list with only the standard and specified [info parameters](/documentation/api/v0.9.2/api-info/#info-parameters). 
